...
<%
    ...
    if (redisHost == null || redisHost.length() == 0) redisHost = "zhanghuiying-redis";
    String redisStatus = "FAIL";
    String sharedId = "";
    Long count = 0L;
    String keyPrefix = "zhanghuiying:session:";
...
<head>
  <meta charset="UTF-8">
  <title>张慧莹 Session共享测试</title>
  <link rel="stylesheet" href="static/course.css">
</head>
<body>
  <main class="panel">
    <h1>Session 共享测试</h1>
    <p class="student">网络一班:张慧莹</p>
    <table>
      <tr><th>项目</th><th>结果</th></tr>
      <tr><td>GitHub目录</td><td>students/zhanghuiying</td></tr>
