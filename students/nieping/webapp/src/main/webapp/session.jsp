...
<%
    ...
    if (redisHost == null || redisHost.length() == 0) redisHost = "nieping-redis";
    String redisStatus = "FAIL";
    String sharedId = "";
    Long count = 0L;
    String keyPrefix = "nieping:session:";
...
<body>
  <main class="panel">
    ...
    <table>
      ...
      <tr><td>GitHub目录</td><td>students/nieping</td></tr>
