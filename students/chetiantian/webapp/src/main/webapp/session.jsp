...
<%
    ...
    if (redisHost == null || redisHost.length() == 0) redisHost = "chetiantian-redis";
    String redisStatus = "FAIL";
    String sharedId = "";
    Long count = 0L;
    String keyPrefix = "chetiantian:session:";
...
<body>
  <main class="panel">
    ...
    <table>
      ...
      <tr><td>GitHub目录</td><td>students/chetiantian</td></tr>
